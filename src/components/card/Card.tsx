...
export function Card({ pseudo="Snox est bo", about="lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci alias aliquid amet aperiam  ", avatar="https://via.placeholder.com/150", tags, reseaux }: Props) {
  ...
  return (
    <article className="p-5 my-4 mx-auto  h-full text-black rounded-lg border-lg border dark:border-black dark:bg-slate-800 bg-slate-300 min-w-[50%]  ">
      <header className="flex flex-col justify-start items-start w-content mb-2">
          ...
          <Paragraph className={"dark:text-green-600 text-green-600 flex items-center justify-start"}>
              🟢 Online
          </Paragraph>
      ...
      <main>
        ...
        <aside className="flex flex-col justfy-center  w-[30%]">
            <div>
                <Paragraph className={"md:text-3xl font-bold"}>
                    About me
                </Paragraph>
            ...
            <div>
                ...
                <div className={"flex justify-start items-center flex-wrap gap-3"}>
                    {tags.map((tag) => { const randomColor = colors[Math.floor(Math.random() * colors.length)]
                        return (
                        <Tag key={tag} content={tag} style={{
            ...
            <div>
                ...
                <div className={"flex justify-start items-center pl-6 "}>
                    ...
                    <div>
                        <div className={"h-18 w-18 rounded-full bg-yellow-300 -mx-6"}></div>
                    </div>
                    <div>
                        <div className={"h-18 w-18 rounded-full bg-green-300 -mx-6"}></div>
                    </div>
                    <div>
                        <div className={"h-18 w-18 rounded-full bg-red-300 -mx-6"}></div>
                    </div>
                    ...
                    <div>
                        <div className={"h-18 w-18 rounded-full bg-purple-300 -mx-6"}></div>
                    </div>
                    <div>
                        <div className={"h-18 w-18 rounded-full bg-blue-300 -mx-6 flex justify-center items-center text-3xl font-bold"}> +8</div>
                    </div>
                </div>
            </div>
