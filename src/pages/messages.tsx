...
import {MyMessage} from "@/components/ui/Messages/MyMessage.tsx";
import {TheirMessage} from "@/components/ui/Messages/TheirMessage.tsx";
import {Divider} from "@/components/ui/Messages/Divider.tsx";
...
export function Messages() {
    return (
        <section className="text-slate-100 pb-20"> {/* TODO: Remove `pb-20` */}
                ...
                <div className="row-start-1 row-end-4 col-start-2 col-end-3">
                    <div className={"w-full h-full overflow-auto px-2 flex flex-col gap-4"}>
                        ...
                        <TheirMessage>
                            ...
                            ultricies aliquam, nunc nisl aliquet nunc, quis aliquam nisl nisl eu nisl. Nullam
                            euismod, nisl eget ultricies aliquam, nunc nisl aliquet nunc, quis aliquam nisl nisl
                            eu nisl.
                        </TheirMessage>
                        ...
                        <MyMessage date={"02 Aout 2023 02:45"}>
                            Tu fais quoi ?
                        </MyMessage>
                        ...
                        <MyMessage date={"02 Aout 2023 12:30 PM"}>
                            Miam! J'espère que ça inclut des recettes pour les amateurs de tacos 🌮🌮
                        </MyMessage>
